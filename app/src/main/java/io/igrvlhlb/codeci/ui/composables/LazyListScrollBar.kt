...
@Composable
fun VerticalLazyGridScrollBar(
    /* defaults from LazyVerticalGrid */
    columns: GridCells,
    ...
    flingBehavior: FlingBehavior = ScrollableDefaults.flingBehavior(),
    userScrollEnabled: Boolean = true,
    /* defaults from LazyVerticalGridScrollbar */
    scrollBarModifier: Modifier = Modifier,
    settings: ScrollbarSettings = ScrollbarSettings.Default,
    indicatorContent: (@Composable (index: Int, isThumbSelected: Boolean) -> Unit)? = null,
    /* content of LazyVerticalGrid */
    content: LazyGridScope.() -> Unit
) {
    LazyVerticalGridScrollbar(state, scrollBarModifier, settings, indicatorContent) {
        LazyVerticalGrid(
            columns,
            lazyGridModifier,
            state,
